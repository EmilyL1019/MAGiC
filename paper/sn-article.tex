...
\title[MAGiC]{MAGiC: Multiple sequence Alignment Guided by Clustered Learning of Approximate Manifolds}
...
\author{\fnm{Emily} \sur{Light}}\email{emily\_light@uri.edu}
